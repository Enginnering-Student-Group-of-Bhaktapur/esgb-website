...
const events_list = [
  ...
  },
  {
    ...
    title: "Deusi Bhailo",
    slug: "20802024013",
    date_of_event: "2023-11-12 to 2023-11-13",
    venue: "Bhaktapur",
    description:
  ...
  },
  {
    ...
    slug: "20802024015",
    date_of_event: "2024-01-26 to 2024-01-28",
    venue: "Pulchowk Campus",
    description:
  ...
  },
  {
    ...
    title: "Dhap Dam Hike",
    slug: "20802024017",
    date_of_event: "2023-12-30",
    venue: "Sundarijal",
    description:
      "Engineering Students' Group of Bhaktapur (ESGB) organizes a hiking program every year following the vibrant Deusi Bhailo program as a refreshing break in nature. \
      Walking the trails together, reaching the destination, and enjoying nature along with the newari khaja in the hike also promotes bonding and interaction among the students and the seniors. \
      Some of the past hiking destinations are Champadevi, Tarkeshwor to Suryachaur to Budhanilkantha, and Sundarijal to Dhap Dam.\
      Main highlights of this event are huge participation exceeding 50, newari khaja set reflecting our unique culture including Yomari, and networking and interaction among the participants.\
      As the destination is much far, ESGB hires a bus and the journey in the bus is filled with songs, and discussions making the journey more mesmerizing. With the conversations among the groups, sharing stories and memories, the hiking is less exhausting and more fun. This event is one of the most exciting, memorable, and refreshing experiences that also strengthens the bond between ESGBians.",
    is_display: true,
    is_featured: false,
    main_image: hike3,
    image_1: hike1,
  ...
  },
  {
    ...
    title: "Changa Chet",
    slug: "20802024018",
    date_of_event: "2023-10-14",
    venue: "Bhakatapur",
    description:
      "Changa Chet Program is organized by ESGB (Engineering Students' Group of Bhaktapur) during the festive occasion of Dashain, two or three days prior to Bijaya Dashami. This event holds significant cultural importance as Dashain is the biggest festival of Nepal and it offers students a unique opportunity to participate actively in traditional festivities. \
      The Changa Chet Program typically commences with the exhilarating activity of flying kites, a cherished tradition during Dashain celebrations followed by tika and blessings from esteemed seniors which reinforces the bond between seniors and juniors. The colorful kites soaring the clear skies of Dashain brings immense joy filling hearts with happiness and excitement among all the participants.\
      Other major highlights of the events are live musical performance, Newari Khaja, and other fun activities creating a vibrant atmosphere and reminding of the values of respect, gratitude, and cherishing bonds and kinship.",
    is_display: true,
    is_featured: false,
    main_image: changa4,
    image_1: changa1,
